...
\resumeProjectHeading {\textbf{Out of Order RISC-V Implementation} \href{https://github.com/AyuubMohamud/Biriq}{\scalebox{0.75}\faLink} $|$ SystemVerilog, C++, Hardware} {May 2024 - Apr 2025, Oct 2025}
\resumeItemListStart
...
\resumeItem{Implemented a \textbf{dedicated test suite} in \textbf{make, bash and C++} for finding microarchitectural bugs.}
...
\begin{itemize}[leftmargin=0.15in, label={}] 
    ...
    \textbf{EDA Tools}{: Synopsys VCS, Synopsys Verdi, Vivado} \\
    \textbf{Programming Languages}{: C, C++, Python, ARMv8 Assembly, RISC-V Assembly} \\
    \textbf{Protocols}{: TileLink, AXI, APB}
    }}
