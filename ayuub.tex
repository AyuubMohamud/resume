...
\resumeItem{\textbf{Modules:} Digital Electronics and Computer Architecture \textbf{(79.8\%)}, Programming for Engineers \textbf{(72.15\%)}, Engineering Project \textbf{(70.62\%)} }
\resumeItemListEnd
...
\resumeProjectHeading {\textbf{Out of Order RISC-V Implementation} \href{https://github.com/AyuubMohamud/Biriq}{\scalebox{0.75}\faLink} $|$  Verilog} {May 2024}
\resumeItemListStart
...
\resumeItem{Executes \textbf{over 140 instructions}, including a \textbf{custom DSP extension}.}
\resumeItem{\textbf{Re-orders} cache requests to allow for more \textbf{optimal} cache utilisation.}
\resumeItem{Implemented a\textbf{ dedicated test suite} \href{https://github.com/AyuubMohamud/biriqTests}{\scalebox{0.75}\faLink}  in \textbf{make} and \textbf{bash} for finding microarchitectural bugs.}
...
\resumeItem{Runs on a low-speed grade FPGA at \textbf{82.5MHZ} whilst taking \textbf{\~10K LUTs}, \textbf{10/240} of the available DSPs and \textbf{4/135} available Block RAMs.}
\resumeItemListEnd

\resumeProjectHeading{\textbf{1st Year Engineering Project}}{May-Jun 2024}
\resumeItemListStart
...
\resumeItem{In charge of managing the team's finances, ordering parts and discussing them with team members.}
\resumeItem{Collaborated with team members to help \textbf{develop} the rover firmware and radio demodulation circuit.}
\resumeItem{Achieved \textbf{70.62\%} for this project (First Class).}
\resumeItemListEnd

\resumeProjectHeading{\textbf{TileLink-based SOC infrastructure } \href{https://github.com/AyuubMohamud/TileLinkIP}{\scalebox{0.75}\faLink} $|$ Verilog }{Nov 2023}
\resumeItemListStart
...
\resumeItem{Contains \textbf{crossbars, GPIO controller, DMA controller and more} allowing for extensible SOCs.}
\resumeItemListEnd

\resumeProjectHeading{\textbf{ARMv8-A C Compiler } \href{https://github.com/AyuubMohamud/sfce}{\scalebox{0.75}\faLink} $|$ C++ }{Nov 2023}
\resumeItemListStart
\resumeItem{Built a compiler for a \textbf{subset of C in C++} targeting the \textbf{ARMv8-A} architecture.}
\resumeItem{Hand-wrote the lexer and \textbf{recursive descent C parser}.}
